...
// ===== Page =====
export default function CarbonDashPage() {
    const sp = useSearchParams();
    const router = useRouter();
    const id = sp.get("plot") || "";
    const mode = (sp.get("mode") === "pro" ? "pro" : "simple") as "simple" | "pro";
            ...
            <div className="mx-auto max-w-6xl">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <button onClick={() => router.push("/")} className="px-3 py-2 text-sm rounded-lg border border-emerald-400 bg-white hover:bg-emerald-700 hover:text-white">ย้อนกลับ</button>
                    </div>
                </div>
